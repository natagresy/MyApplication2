...
public interface RetrofitMaps {
    ...
    Call<Example> getNearbyPlaces(@Query("type") String type,@Query("name") String name, @Query("location") String location, @Query("radius") int radius, @Query("key") String key);
